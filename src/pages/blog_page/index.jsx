...
const Blog = () => {
  ...
  useEffect(() => {
    axios.get(`https://jsonplaceholder.typicode.com/posts/${param.post_id}`)
          ...
          <center>
            <div className='only_one'>
              ...
              <div className='helllo'>
                ...
                <p className='p1'>Tracey Wilson</p>
                <p>August 20, 2022</p>
              </div>
              <div className='blog'>
                ...
                <p className='italic'><i>“ Traveling can expose you to new environments and potential health risks, so it's crucial to take precautions to stay safe and healthy. ”</i></p>
                <img src={require('../../images/Image (1).jpg')} alt="" />
                <div className="card2">
                  <h4>Advertisement</h4>
